...
const ee = (n) => {
  ...
  const e = n.product_type_details.end_date, t = n.product_type_details.end_time;
  let r = e + "T";
  const i = t.split(" "), o = i[0].split(":");
  let s = parseInt(o[0]) + (i[1] === "PM" ? 12 : 0);
  s -= o[0] === "12" ? 12 : 0;
  const a = o[1];
  return s.toString().length === 1 && (r += "0"), r += `${s}:${a}:00${n.product_type_details.timezone_info.utc_offset_string}`, new Date(r);
};
class De {
  /**
