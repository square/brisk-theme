...
class B {
  ...
  async autocompletePlaces(e) {
    const t = this.initConfig.userId, i = this.initConfig.siteId, o = "", n = e.address, s = `${o}/app/store/api/v28/pub/users/${t}/sites/${i}/places?types=geocode&input=${n}`;
  ...
  async getPlace(e) {
    const t = this.initConfig.userId, i = this.initConfig.siteId, o = "", n = e.placeId, s = `${o}/app/store/api/v28/pub/users/${t}/sites/${i}/places/${n}`, c = await (await fetch(s, {
      method: "GET",
      headers: I()
    })).json();
...
class Z {
  ...
  async getCoordinates() {
    const e = this.initConfig.userId, i = `/app/website/cms/api/v1/users/${e}/customers/coordinates`;
